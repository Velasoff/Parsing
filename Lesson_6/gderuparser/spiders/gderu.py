...
class GderuSpider(scrapy.Spider):
    ...
    def __init__(self, mark):
        self.start_urls = [f'https://sarov.gde.ru/yelektronnaya_tehnika?Filter[district_id]=&Filter[search_string]={mark}']

    def parse(self, response: HtmlResponse):
        ads_links = response.xpath('//li[@class="text control forward last-none"]/a/@href').extract()
